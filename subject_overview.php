                            ...
                            <div class="widget-bg">
                                <div class="widget-body clearfix">
									...
									?>
										  ...
										  <a href="edit_subject_overview.php<?php echo '?id='.$get_id; ?>&<?php echo 'subject_id='.$id; ?>" class="btn btn-primary btn-rounded ripple float-right"><i class="material-icons list-icon">edit</i>&nbsp; Modifier Déscription</a>
									 <?php }else{ ?>
										     <a href="add_subject_overview.php<?php echo '?id='.$get_id; ?>" class="btn btn-primary btn-rounded ripple float-right"><i class="material-icons list-icon">add_circle_outline</i>&nbsp; Ajouter Déscription</a>
									 <?php } ?>
                                                <p><?php	if($row){
									 echo $row['content']; } ?></p>
