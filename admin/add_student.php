    ...
    <div class="content-wrapper">
        ...
        <main class="main-wrapper clearfix">
            ...
            <form id="add_student" method="post"  >
                                            ...
                                            <label class="col-md-3 col-form-label" for="inputPassword">Niveau</label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control"  name="un"  id="focusedInput" placeholder="Id d'étudiant" type="text">
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Nom</label>
                                            <div class="col-md-9">
                                                <input class="form-control" class="span8" name="fn"  id="focusedInput" placeholder="Nom" type="text">
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Prenom</label>
                                            <div class="col-md-9">
                                                <input class="form-control" class="span1" name="ln" id="focusedInput" placeholder="prenom" type="text">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" class="span1" name="pass" id="focusedInput" placeholder="Mot de passe" type="password">
                                            </div>
                                        </div>
                                        ...
                                        <center>
                                            ...
                                            <button name="save"  class="btn btn-block btn-primary ripple">Ajouter étudiant</button>
                                        </div>
                                        </center>
