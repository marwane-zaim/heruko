        ...
        <main class="main-wrapper clearfix">
            ...
            <form method="post">
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Departement</label>
                                            <div class="col-md-9">
                                                <input class="form-control"  value="<?php echo $row['department_name']; ?>" id="focusedInput" name="d" placeholder="Departement" type="text">
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Responsable de departement</label>
                                            <div class="col-md-9">
                                                <input class="form-control"  value="<?php echo $row['dean']; ?>" id="focusedInput" name="dn" " placeholder="Responsable" type="text">
                                            </div>
                                        </div>
