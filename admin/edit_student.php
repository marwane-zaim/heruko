        ...
        <main class="main-wrapper clearfix">
            ...
            <form method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                            <select class="form-control" name="cys" data-toggle="select2" data-plugin-options='{"minimumResultsForSearch": -1}'>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Id d'étudiant</label>
                                            <div class="col-md-9">
                                                <input class="form-control"  name="un" value="<?php echo $row['username']; ?>" id="inputEmail" placeholder="Id de matiére" type="text">
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Nom</label>
                                            <div class="col-md-9">
                                                <input class="form-control"  name="fn"  value="<?php echo $row['firstname']; ?>" id="inputPassword" placeholder="Nom de matiére" type="text">
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Prenom</label>
                                            <div class="col-md-9">
                                                <input class="form-control"  name="ln"  value="<?php echo $row['lastname']; ?>" id="inputPassword" placeholder="Nombre d'unité" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Mot de passe</label>
                                            <div class="col-md-9">
                                                <input class="form-control"  name="password"  value="<?php echo $row['password']; ?>" id="inputPassword" placeholder="Nombre d'unité" type="password">
                                            </div>
                                        </div>
          ...
          <?php
                            if (isset($_POST['update'])) {
                                ...
                                mysqli_query($conn,"update student set username = '$un' , firstname ='$fn' , lastname = '$ln' , class_id = '$cys' , password = '$password' where student_id = '$get_id' ")or die(mysqli_error());
