         ...
         <div class="widget-holder col-md-12">
                            ...
                            <div class="widget-bg">
                                <div class="widget-body " >
                                    <h5 class="box-title">Liste des étudiants</h5>
                                    ...
                                    <table class="table table-striped" cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                        <a href="add_student.php" class="col-md-2 col-sm-3 col-4"><i class="material-icons">add</i>
                                           
                                        </a>

                                        <a class="col-md-2 col-sm-3 col-4 red" data-toggle="modal" href="#student_delete" 
                                        id="delete" name=""><i class="material-icons">delete</i>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td width="30">
                                                    ...
                                                    <a href="edit_student.php<?php echo '?id='.$id; ?>" class="col-md-2 col-sm-3 col-4">
