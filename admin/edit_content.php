        ...
        <main class="main-wrapper clearfix">
            ...
            <form method="post">
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Titre</label>
                                            <div class="col-md-9">
                                                <input class="form-control"   value="<?php echo $row['title']; ?>" name="title" id="inputEmail" id="inputEmail" placeholder="Titre" type="text">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <textarea class="form-control" name="content" id="ckeditor_full">
