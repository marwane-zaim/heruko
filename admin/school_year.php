         ...
         <div class="widget-holder col-md-12">
                            <div class="widget-bg">
                                <div class="widget-body ">
                                    ...
                                    <h5 class="box-title">Liste des classes</h5>
                                    ...
                                    <table class="table table-striped" cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                        <a href="add_school_year.php" class="col-md-2 col-sm-3 col-4"><i class="material-icons">add</i>
