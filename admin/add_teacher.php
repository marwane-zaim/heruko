    ...
    <div class="content-wrapper">
        ...
        <main class="main-wrapper clearfix">
            ...
            <form  method="post"  >
                                            ...
                                            <label class="col-md-3 col-form-label" for="inputPassword">Département</label>
                                            <div class="col-md-9">
                                            <select class="form-control" name="class_id"  data-toggle="select2" data-plugin-options='{"minimumResultsForSearch": -1}'>
                                                <option></option>
                                             <?php
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control"   name="username" id="focusedInput" placeholder="Id d'étudiant" type="text">
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Nom</label>
                                            <div class="col-md-9">
                                                <input class="form-control" class="span8" name="firstname" id="focusedInput" placeholder="Nom" type="text">
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Prenom</label>
                                            <div class="col-md-9">
                                                <input class="form-control" class="span1"name="lastname" id="focusedInput" placeholder="prenom" type="text">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" class="span1" name="password" id="focusedInput" placeholder="Mot de passe" type="password">
                                            </div>
                                        </div>
                                        ...
                                        <center>
                                            ...
                                            <button name="save"  class="btn btn-block btn-primary ripple">Ajouter enseignant</button>
                                        </div>
                                        </center>
    ...
    <!-- Scripts -->
                        ...
                        <?php
                            if (isset($_POST['save'])) {
                                ...
                                mysqli_query($conn,"insert into teacher (username,firstname,lastname,location,password,department_id)
                                values ('$username','$firstname','$lastname','uploads/NO-IMAGE-AVAILABLE.jpg','$password','$department_id')         
                                ") or die(mysqli_error()); ?>
                                <script>
