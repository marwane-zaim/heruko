        ...
        <main class="main-wrapper clearfix">
            ...
            <form method="post">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control"  value="<?php echo $row['subject_code']; ?>" name="subject_code" id="inputEmail" placeholder="Id de matiére" type="text">
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Nom de matiére</label>
                                            <div class="col-md-9">
                                                <input class="form-control"  value="<?php echo $row['subject_title']; ?>" class="span8" name="title" id="inputPassword" placeholder="Nom de matiére" type="text">
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Nombre d'unité</label>
                                            <div class="col-md-9">
                                                <input class="form-control" value="<?php echo $row['unit']; ?>" class="span1" name="unit" id="inputPassword" placeholder="Nombre d'unité" type="text">
                                            </div>
                                        </div>
