        ...
        <main class="main-wrapper clearfix">
            ...
            <form method="post">
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Nom de classe</label>
                                            <div class="col-md-9">
                                                <input class="form-control"  name="class_name"  id="focusedInput"  placeholder="Nom de classe" type="text">
                                            </div>
                                        ...
                                        <center>
                                            ...
                                            <button name="save" type="submit"  class="btn btn-block btn-primary ripple">Ajouter classe</button>
                                        </div>
