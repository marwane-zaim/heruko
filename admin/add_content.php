        ...
        <main class="main-wrapper clearfix">
            ...
            <form method="post">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control"  name="title" id="inputEmail" placeholder="Titre" type="text">
                                            </div>
                                        </div>
                                        ...
                                        <center>
                                            ...
                                            <button name="save" type="submit"  class="btn btn-block btn-primary ripple">Ajouter contenue</button>
                                        </div>
                                        </center>
