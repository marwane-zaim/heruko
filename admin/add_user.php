        ...
        <main class="main-wrapper clearfix">
            ...
            <form method="post">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" name="firstname" id="focusedInput"  placeholder="Nom" type="text">
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Prenom</label>
                                            <div class="col-md-9">
                                                <input class="form-control" class="span8" name="lastname" id="focusedInput" placeholder="Prenom" type="text">
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Username</label>
                                            <div class="col-md-9">
                                                <input class="form-control" class="span1" name="username" id="focusedInput" placeholder="Username" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <center>
                                            ...
                                            <button name="save" type="submit"  class="btn btn-block btn-primary ripple">Ajouter admin</button>
                                        </div>
                                        </center>
