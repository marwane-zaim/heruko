...
<?php
            ...
            <form method="post">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="inputPassword">Classe</label>
                                            <div class="col-md-9">
                                            <select class="form-control" name="department"  data-toggle="select2" data-plugin-options='{"minimumResultsForSearch": -1}'>
                                               <?php
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Id d'enseignant</label>
                                            <div class="col-md-9">
                                                <input class="form-control" value="<?php echo $row['username']; ?>" name="username" id="focusedInput" placeholder="Id " type="text">
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Nom</label>
                                            <div class="col-md-9">
                                                <input class="form-control"  value="<?php echo $row['firstname']; ?>"  name="firstname" id="focusedInput" placeholder="Nom" type="text">
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Prenom</label>
                                            <div class="col-md-9">
                                                <input class="form-control"  name="lastname" value="<?php echo $row['lastname']; ?>" id="inputPassword" placeholder="prénom" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Mot de passe</label>
                                            <div class="col-md-9">
                                                <input class="form-control"  name="password"  value="<?php echo $row['password']; ?>" id="inputPassword" placeholder="mot de passe" type="password">
                                            </div>
                                        </div>
                                        ...
                                        <center>
                                            ...
                                            <button name="update" type="submit"  class="btn btn-block btn-primary ripple">enregistrer</button>
                                        </div>
                                        </center>
                   ...
                   <?php
                            if (isset($_POST['update'])) {
                                ...
                                $query = mysqli_query($conn,"select * from teacher where username = '$username' and firstname = '$firstname' and lastname = '$lastname' and password = '$password' ")or die(mysqli_error());
                                ...
                                mysqli_query($conn,"update teacher set username = '$username' , firstname = '$firstname' , lastname = '$lastname' , department_id = '$department_id' , password = '$password' where teacher_id = '$get_id' ")or die(mysqli_error());  
