        ...
        <main class="main-wrapper clearfix">
            ...
            <form method="post">
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Nom de departement</label>
                                            <div class="col-md-9">
                                                <input class="form-control"  id="focusedInput" name="d" placeholder="Nom de departement" type="text">
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Responsable de departement</label>
                                            <div class="col-md-9">
                                                <input class="form-control" class="span8" id="focusedInput" name="pi" placeholder="Responsable de departement" type="text">
                                            </div>
                                        </div>
                                        ...
                                        <center>
                                            ...
                                            <button name="save" type="submit"  class="btn btn-block btn-primary ripple">Ajouter departement</button>
                                        </div>
                                        </center>
