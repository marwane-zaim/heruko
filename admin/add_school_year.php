        ...
        <main class="main-wrapper clearfix">
            ...
            <form method="post">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control"  name="school_year" id="focusedInput"  placeholder="Année scolaire" type="text">
                                            </div>
                                        ...
                                        <center>
                                            ...
                                            <button name="save" type="submit"  class="btn btn-block btn-primary ripple">Ajouter Année</button>
                                        </div>
...
mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$user_username','Ajouter une année scolaire $school_year')")or die(mysqli_error());
?>
<script>
