         ...
         <div class="widget-holder col-md-12">
                            <div class="widget-bg">
                                <div class="widget-body ">
                                    <h5 class="box-title">Liste de matiéres</h5>
                                    
                                    <form action="delete_subject.php" method="post">
                                    <table class="table table-striped" cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                        <a href="add_subject.php" class="col-md-2 col-sm-3 col-4"><i class="material-icons">add</i>
                                           
                                        </a>

                                        <a class="col-md-2 col-sm-3 col-4 red" data-toggle="modal" href="#subject_delete" id="delete" name=""><i class="material-icons">delete</i>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td width="30">
                                                    ...
                                                    <a href="edit_subject.php<?php echo '?id='.$id; ?>" class="col-md-2 col-sm-3 col-4">
