            ...
            <form method="post">
                                        <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" class="span8" name="lastname" value="<?php echo $row['lastname']; ?>" id="focusedInput" placeholder="Prenom" type="text">
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Username</label>
                                            <div class="col-md-9">
                                                <input class="form-control" class="span1" value="<?php echo $row['username']; ?>" name="username" id="focusedInput" placeholder="Username" type="text">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" class="span1" value="<?php echo $row['password']; ?>" name="password" id="focusedInput" placeholder="Mot de passe" type="password">
                                            </div>
                                        </div>
                                        ...
                                        <center>
                                            ...
                                            <button name="update" type="submit"  class="btn btn-block btn-primary ripple">enregister</button>
                                        </div>
                                        </center>
