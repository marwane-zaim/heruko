         ...
         <div class="widget-holder col-md-12">
                            <div class="widget-bg">
                                <div class="widget-body ">
                                    <h5 class="box-title">Liste des enseigants</h5>
                                    
                                    <form action="delete_teacher.php" method="post">
                                    <table class="table table-striped" cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                        <a href="add_teacher.php" class="col-md-2 col-sm-3 col-4"><i class="material-icons">add</i>
                                           
                                        </a>

                                        <a class="col-md-2 col-sm-3 col-4 red" data-toggle="modal" href="#teacher_delete" id="delete" name=""><i class="material-icons">delete</i>
                                    ...
                                    <td width="120"><a href="de_activate.php<?php echo '?id='.$id; ?>" class="btn btn-danger"><i class="icon-remove"></i> congé</a></td>
                                    <?php }else{ ?>
                                    <td width="120"><a href="desactivate.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-check"></i> Disponible</a></td>               
                                    <?php } ?>


                                                <td width="30">

                                                    <a href="edit_teacher.php<?php echo '?id='.$id; ?>" class="col-md-2 col-sm-3 col-4">
