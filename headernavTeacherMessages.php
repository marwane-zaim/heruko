...
notifications
                    ...
                    <li class="menu-item-has-children current-page"><a href="dasboard_teacher.php"><i class="list-icon material-icons">group</i> <span class="hide-menu">Mes Classes</span></a>
			...
			?>
                    ...
                    <li class="menu-item-has-children active"><a href="teacher_message.php"><i class="list-icon material-icons">email</i>
