	...
	?>
                    ...
                    <div class="row">
                            ...
                            <div class="widget-bg-transparent">
                                <div class="widget-body clearfix">
                                    ...
                                    <div class="accordion" id="accordion-4" role="tablist" aria-multiselectable="true">
                                        <div class="card card-outline-primary">
                                            <div class="card-header" role="tab" id="heading10">
                                                <h6 class="card-title"><a role="button" data-toggle="collapse" data-parent="#accordion-4" href="#collapse41" aria-expanded="true" aria-controls="collapse41"><i class="align-middle material-icons md-18 mr-1 mr-0-rtl ml-1-rtl">description</i> Mes devoires</a></h6>
                                            </div>
                                            <!-- /.card-header -->
									...
									?>     
										...
										<button  title="Afficher étudiant qui a posté ce document" id="<?php echo $id; ?>view" class="btn btn-warning"><i class="material-icons list-icon">visibility</i> </button>
									   ...
									   <?php 
										...
										?>
										 <a data-placement="bottom"  id="<?php echo $id; ?>download"  class="btn btn-info" href="<?php echo $row['floc']; ?>">
                                         <i class="material-icons list-icon">file_download</i></a>
										<?php } ?>
										 <a data-placement="bottom"  id="<?php echo $id; ?>remove"  class="btn btn-danger"  href="delete_assignment.php<?php echo '?id='.$id; ?>" ><i class="material-icons list-icon">delete_forever</i></a>
                                        ...
                                        <div class="card card-outline-info">
                                            <div class="card-header" role="tab" id="heading11">
                                                <h6 class="card-title"><a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion-4" href="#collapse42" aria-expanded="false" aria-controls="collapse42">
                                                <i class="material-icons md-18 align-middle mr-1 mr-0-rtl ml-1-rtl">add_circle_outline</i> Ajouter un devoir</a></h6>
                                            </div>
                                            <!-- /.card-header -->
                        ...
                        <div class="control-group">
                            ...
                            <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="l0">Devoir</label>
                                            <div class="col-md-9">
                                                <input class="form-control"type="text" name="name" Placeholder="Choisir un nom pour le devoir"  class="input" required>
                                            </div>
                                        </div>
										<div class="form-group row">
                        ...
                        <div class="control-group">
                            <div class="controls">
                                ...
                                <button name="Upload" type="submit" value="Upload" class="btn btn-success" /><i class="icon-upload-alt"></i>&nbsp; Ajouter </button>
                            </div>
                        </div>
                    </form>
                                </div>
			...
			jQuery(document).ready(function($){
				$("#add_downloadble").submit(function(e){
					$.jGrowl("devoir est entrain de téléchargement......", { sticky: true });
					e.preventDefault();
					var _this = $(e.target);
					...
					$.ajax({
						...
						success: function(html){
							$.jGrowl("devoir a été bien ajouté", );
                            setTimeout(function(){
