    ...
    <div class="content-wrapper">
        ...
        <aside class="site-sidebar scrollbar-enabled" data-suppress-scroll-x="true">
			...
			<?php include('count.php'); ?>
				...
				<li class="menu-item-has-children "><a href="student_notification.php"><i class="list-icon material-icons"><span class="material-icons">
notifications
                    ...
                    <li class="menu-item-has-children current-page active "><a href="dashboard_student.php"><i class="list-icon material-icons">group</i> <span class="hide-menu">Mes Classes</span></a>
                    <ul class="list-unstyled sub-menu">
                    <li class=""><a href="dashboard_student.php"><i class="icon-chevron-right"></i><i class="icon-chevron-left"></i>&nbsp;Mes classes</a></li>
				<li class=""><a href="my_classmates.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;Mes camarades</a></li>
				<li class=""><a href="progress.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-bar-chart"></i>&nbsp;Mon progres</a></li>
				<li class=""><a href="subject_overview_student.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-file"></i>&nbsp; A propos</a></li>
				<li class=""><a href="downloadable_student.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-download"></i>&nbsp;Mes cours</a></li>
				<li class=""><a href="assignment_student.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-book"></i>&nbsp; Mes devoirs</a></li>
				<li class="active"><a href="announcements_student.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-info-sign"></i>&nbsp;Mes annonces</a></li>
				<li class=""><a href="class_calendar_student.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-calendar"></i>&nbsp; Calendrier</a></li>
