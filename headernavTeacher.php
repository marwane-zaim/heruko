                        ...
                        class="dropdown-menu dropdown-left dropdown-card dropdown-card-profile animated flipInY">
                            <div class="card">
                                ...
                                <ul class="list-unstyled card-body">
                                    ...
                                    <li><a href="change_password_teacher.php"><span><span class="align-middle">Change Password</span></span></a>
                                    </li>
                                    <li><a href="#myModal"><span><span class="align-middle">Changer Photo profile</span></span></a>
                                    </li>
...
notifications
			...
			?>
                    ...
                    <li class="menu-item-has-children"><a href="teacher_message.php"><i class="list-icon material-icons">lightbulb_outline</i>
