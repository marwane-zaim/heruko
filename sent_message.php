...
<body class="sidebar-light sidebar-expand navbar-brand-dark">
		...
		<main class="main-wrapper clearfix">
            ...
            <div class="container-fluid">
                <div class="row page-title clearfix">
                    ...
                    <h6 class="page-title-heading mr-0 mr-r-5"><b> Message Envoyé </b></h6>
                    </div>
                    <!-- /.page-title-left -->
                                        ...
                                        <div class="mail-list-item unread media scrollmenu" id="del<?php echo $id; ?>">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="d-flex align-items-center mt-3">
                                                    ...
                                                    <div class="flex-1"></div>
													<span class="text-muted fs-12"><?php echo $row['date_sended']; ?></span>
                                                </div>
                                                <!-- /.d-flex -->
                                            </div>
                                            <!-- /.media-body -->
	...
	$(document).ready( function() {
		...
		var id = $(this).attr("id");
			...
			$('#'+id).modal('hide');
			$.jGrowl("Message supprimé", { header: 'Data Delete' });	
			}
			}); 		
			return true;
		});				
