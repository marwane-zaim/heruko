...
<body class="sidebar-light sidebar-expand navbar-brand-dark">
    <div id="wrapper" class="wrapper">
             <?php include('headernavTeacher.php'); ?>	
        <!-- /.site-sidebar -->
    ...
    <script>
                CKEDITOR.replace('ckeditor_full')    ;
														...
														<button name="save" type="submit" class="btn btn-primary btn-rounded ripple float-right"><i class="material-icons list-icon">save</i>&nbsp; Enregistrer</button>
														</div>
														</div>
														</form>
														<?php
